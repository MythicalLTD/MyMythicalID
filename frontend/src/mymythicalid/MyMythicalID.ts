...
export class MyMythicalID {
    private static instance: MyMythicalID | null = null;
    private container: HTMLDivElement | null = null;
    private terminal: HTMLDivElement | null = null;
    private options: Required<MyMythicalIDOptions>;

    private installSteps: InstallStep[] = [
        {
            message: 'Initializing MyMythicalID environment',
            duration: 800,
            icon: '🚀',
        },
        {
    ...
    private defaultOptions: Required<MyMythicalIDOptions> = {
        timeout: 7000,
        theme: 'dark',
        accentColor: '#6366f1', // Indigo color
    };

    private constructor(options: MyMythicalIDOptions = {}) {
        this.options = { ...this.defaultOptions, ...options };
    }

    public static getInstance(options?: MyMythicalIDOptions): MyMythicalID {
        if (!MyMythicalID.instance) {
            MyMythicalID.instance = new MyMythicalID(options);
        }
        return MyMythicalID.instance;
    }
    ...
    `,
        ...
        // Welcome Message
        console.log('%cWelcome to MyMythicalID! 🚀', styles.subtitle);
        ...
        // Credits
        console.log('%c💜 Made with love by the MyMythicalID Team', styles.subtitle);

        MyMythicalID.warnNotPaste();
    }
