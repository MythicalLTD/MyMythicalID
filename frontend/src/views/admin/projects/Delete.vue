    ...
    <LayoutDashboard>
        ...
        <template v-else-if="project">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-pink-400">Delete Project: {{ project.name }}</h1>
                <button
            ...
            <div class="bg-gray-800/50 backdrop-blur-md rounded-lg p-6">
                <div class="mb-6 flex items-start">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-white">Confirm Project Deletion</h2>
                        <p class="text-gray-400 mt-2">
                            You are about to delete the project
                            <span class="font-bold text-white">"{{ project.name }}"</span>. This action cannot be
                            undone.
                        </p>
                        <p class="text-gray-400 mt-2">
                            If any data is associated with this project, it may become inaccessible or display
                            incorrectly.
                        </p>
                    </div>
                </div>
                ...
                <div class="bg-gray-900/50 rounded-lg p-4 mb-6">
                    <h3 class="text-white font-medium mb-2">Project Details</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            ...
                            <p class="text-white">{{ project.type.charAt(0).toUpperCase() + project.type.slice(1) }}</p>
                        </div>
                        <div>
                            <p class="text-gray-400">UUID</p>
                            <p class="text-white">{{ project.uuid }}</p>
                        </div>
        ...
        <div v-else class="bg-gray-800/50 backdrop-blur-md rounded-lg p-6 text-center">
            ...
            <p class="text-gray-400 mt-2">
                The project you're trying to delete doesn't exist or has already been deleted.
            </p>
            <button
                @click="router.push('/mc-admin/projects')"
    ...
    try {
        ...
        if (response.success) {
            ...
            const errorMessages = {
                ...
                FAILED_TO_DELETE_PROJECT: 'Server failed to delete the project',
            ...
            const errorMessage = errorMessages[error_code] || 'Failed to delete project';
