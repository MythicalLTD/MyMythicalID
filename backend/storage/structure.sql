...
CREATE TABLE `mymythicalid_announcements` (
  `id` int(11) NOT NULL,
  `title` text NOT NULL,
...
CREATE TABLE `mymythicalid_announcements_assets` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `mymythicalid_announcements_tags` (
  `id` int(11) NOT NULL,
  `announcements` int(16) NOT NULL,
  `tag` text NOT NULL,
  `deleted` enum('false','true') NOT NULL DEFAULT 'false',
...
CREATE TABLE `mymythicalid_departments` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE `mymythicalid_mail_templates` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
...
CREATE TABLE `mymythicalid_paypal_payments` (
  `id` int(11) NOT NULL,
  `code` text NOT NULL,
...
CREATE TABLE `mymythicalid_roles` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
...
INSERT INTO `mymythicalid_roles` (`id`, `name`, `real_name`, `deleted`, `locked`, `date`) VALUES
(1, 'Default', 'default', 'false', 'false', '2025-04-25 08:16:00'),
(2, 'VIP', 'vip', 'false', 'false', '2025-04-25 08:16:00'),
(3, 'Support Buddy', 'supportbuddy', 'false', 'false', '2025-04-25 08:16:00'),
(4, 'Support', 'support', 'false', 'false', '2025-04-25 08:16:00'),
(5, 'Support LVL 3', 'supportlvl3', 'false', 'false', '2025-04-25 08:16:00'),
(6, 'Support LVL 4', 'supportlvl4', 'false', 'false', '2025-04-25 08:16:00'),
(7, 'Admin', 'admin', 'false', 'false', '2025-04-25 08:16:00'),
(8, 'Administrator', 'administrator', 'false', 'false', '2025-04-25 08:16:00');
...
CREATE TABLE `mymythicalid_settings` (
...
CREATE TABLE `mymythicalid_stripe_payments` (
  `id` int(11) NOT NULL,
  `code` text NOT NULL,
  `coins` int(11) NOT NULL,
  `user` varchar(36) NOT NULL,
...
CREATE TABLE `mymythicalid_tickets` (
  `id` int(11) NOT NULL,
  `user` varchar(36) NOT NULL,
  `department` int(16) NOT NULL,
  `priority` enum('low','medium','high','urgent') NOT NULL DEFAULT 'low',
  `status` enum('open','closed','waiting','replied','inprogress') NOT NULL DEFAULT 'open',
  `title` text NOT NULL,
  `description` text NOT NULL,
  `deleted` enum('false','true') NOT NULL DEFAULT 'false',
  `locked` enum('false','true') NOT NULL DEFAULT 'false',
...
CREATE TABLE `mymythicalid_tickets_attachments` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `mymythicalid_tickets_messages` (
  `id` int(11) NOT NULL,
  `ticket` int(16) NOT NULL,
  `user` varchar(36) NOT NULL,
...
CREATE TABLE `mymythicalid_users` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `mymythicalid_users_activities` (
  `id` int(11) NOT NULL,
  `user` varchar(36) NOT NULL,
...
CREATE TABLE `mymythicalid_users_apikeys` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
  `user` varchar(36) NOT NULL,
...
CREATE TABLE `mymythicalid_users_email_verification` (
  `id` int(11) NOT NULL,
  `code` text NOT NULL,
  `user` varchar(36) NOT NULL,
...
CREATE TABLE `mymythicalid_users_mails` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `mymythicalid_users_notifications` (
  `id` int(11) NOT NULL,
  `user` varchar(36) NOT NULL,
  `name` text NOT NULL,
  `description` text NOT NULL,
...
--
ALTER TABLE `mymythicalid_announcements`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mymythicalid_announcements_assets`
--
ALTER TABLE `mymythicalid_announcements_assets`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `mymythicalid_announcements_tags`
  ADD PRIMARY KEY (`id`),
  ADD KEY `announcements` (`announcements`);
...
--
ALTER TABLE `mymythicalid_departments`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mymythicalid_mail_templates`
--
ALTER TABLE `mymythicalid_mail_templates`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mymythicalid_paypal_payments`
--
ALTER TABLE `mymythicalid_paypal_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_roles`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mymythicalid_settings`
--
ALTER TABLE `mymythicalid_settings`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mymythicalid_stripe_payments`
--
ALTER TABLE `mymythicalid_stripe_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_tickets`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`),
...
--
ALTER TABLE `mymythicalid_tickets_attachments`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `mymythicalid_tickets_messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ticket` (`ticket`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_users`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `mymythicalid_users_activities`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_users_apikeys`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_users_email_verification`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_users_mails`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_users_notifications`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `mymythicalid_settings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'The id of the setting!';
...
--
ALTER TABLE `mymythicalid_announcements_assets`
  ADD CONSTRAINT `mymythicalid_announcements_assets_ibfk_1` FOREIGN KEY (`announcements`) REFERENCES `mymythicalid_announcements` (`id`);

--
-- Constraints for table `mymythicalid_announcements_tags`
--
ALTER TABLE `mymythicalid_announcements_tags`
  ADD CONSTRAINT `mymythicalid_announcements_tags_ibfk_1` FOREIGN KEY (`announcements`) REFERENCES `mymythicalid_announcements` (`id`);

--
-- Constraints for table `mymythicalid_paypal_payments`
--
ALTER TABLE `mymythicalid_paypal_payments`
  ADD CONSTRAINT `mymythicalid_paypal_payments_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_stripe_payments`
--
ALTER TABLE `mymythicalid_stripe_payments`
  ADD CONSTRAINT `mymythicalid_stripe_payments_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_tickets`
--
ALTER TABLE `mymythicalid_tickets`
  ADD CONSTRAINT `mymythicalid_tickets_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`),
...
--
ALTER TABLE `mymythicalid_tickets_attachments`
  ADD CONSTRAINT `mymythicalid_tickets_attachments_ibfk_1` FOREIGN KEY (`ticket`) REFERENCES `mymythicalid_tickets` (`id`);

--
-- Constraints for table `mymythicalid_tickets_messages`
--
ALTER TABLE `mymythicalid_tickets_messages`
  ADD CONSTRAINT `mymythicalid_tickets_messages_ibfk_1` FOREIGN KEY (`ticket`) REFERENCES `mymythicalid_tickets` (`id`),
...
--
ALTER TABLE `mymythicalid_users`
  ADD CONSTRAINT `mymythicalid_users_ibfk_1` FOREIGN KEY (`role`) REFERENCES `mymythicalid_roles` (`id`);

--
-- Constraints for table `mymythicalid_users_activities`
--
ALTER TABLE `mymythicalid_users_activities`
  ADD CONSTRAINT `mymythicalid_users_activities_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_users_apikeys`
--
ALTER TABLE `mymythicalid_users_apikeys`
  ADD CONSTRAINT `mymythicalid_users_apikeys_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_users_email_verification`
--
ALTER TABLE `mymythicalid_users_email_verification`
  ADD CONSTRAINT `mymythicalid_users_email_verification_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_users_mails`
--
ALTER TABLE `mymythicalid_users_mails`
  ADD CONSTRAINT `mymythicalid_users_mails_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);

--
-- Constraints for table `mymythicalid_users_notifications`
--
ALTER TABLE `mymythicalid_users_notifications`
  ADD CONSTRAINT `mymythicalid_users_notifications_ibfk_1` FOREIGN KEY (`user`) REFERENCES `mymythicalid_users` (`uuid`);
COMMIT;
